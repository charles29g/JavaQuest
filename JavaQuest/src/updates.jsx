      ...
      <div className="update-section">
        <div className="update-content">
          <h1 className="update-title">
            <em>Stay Ahead.</em> Stay{" "}
            <span className="highlight">Updated.</span>
          </h1>
          <p className="update-description">
            Make the most out of your Java learning journey by staying up to
            date with the <em>latest features</em>,{" "}
            <em>security improvements</em>, and
          ...
          <div className="update-box">
            ...
            <p className="box-text">
              ...
              Oracle. Don’t miss out on critical updates that keep your Java
              apps safe and powerful.
            </p>
            <a

export default function ModuleItem({ id,name, quiz, img, setPage, setModuleID} ) {
  return (
      ...
      <div className="row g-4 align-items-center">
        ...
        <div className="col-12 col-md-7 d-flex flex-column justify-content-center">
          <div className="d-flex justify-content-md-end justify-content-center py-2">
            <button className="btn btn-light shadow-button btn-mod text-start w-100 w-md-75 fs-md-5" onClick={() => { setPage("moduleLessons" ); setModuleID(id)}}
            >
              {name}{id}
            </button>
          </div>
